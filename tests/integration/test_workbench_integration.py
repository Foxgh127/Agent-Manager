...
import tests.routing.test_model_compatibility as compatibility
...
class ModelPreferencePersistenceV97Tests(unittest.TestCase):
    ...
    def test_custom_preference_survives_provider_save_and_catalog_refresh(self):
        ...
        with (
            ...
            patch.object(agent_manager.models.preferences.agent_manager.sessions.live_selection, "inspect_live_selection", return_value={"sourceId": "account:other"}),
            ...
            agent_manager.models.preferences.save_reasoning("relay", "gpt-6-astra", {"mode": "custom", "efforts": ["high", "ultra"], "defaultEffort": "high"})
