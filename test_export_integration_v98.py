...
from account_portability import portable_account_metadata
from test_account_portability_v98 import auth, jwt, cockpit_full_token_mirror
...
class ExportIntegrationTests(unittest.TestCase):
    ...
    def test_new_namespace_metadata_survives_local_batch_preview(self):
        from account_portability import build_portable_account_export
