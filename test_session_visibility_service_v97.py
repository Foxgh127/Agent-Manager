...
from test_session_visibility_v96 import _fixture, _sha, _thread
...
def test_lazy_core_import():
    result = subprocess.run(
        [sys.executable, "-c", "import sys; import session_visibility_service; assert 'agent_manager_core' not in sys.modules"],
